     ...
     return (
         ...
         <Dimmer style = {{backgroundColor: "teal", opacity: "0.7"}} active={active} page>
            <Header as='h1' inverted>
              ...
              <Image src={largeSucculent} style={{width: "8%", height:"30%", marginLeft: "45%"}} />
             <Divider style={{color: "teal", width:"10%"}} />
             <Header as='h2' inverted>Thank You for Stopping By.</Header>
             <Header as='h3'inverted>Tend Your Garden Again With Us Soon!</Header>
             <Link to='/'>
             <Button
               name="logout"
